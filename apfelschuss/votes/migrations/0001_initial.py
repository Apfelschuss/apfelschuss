# Generated by Django 2.0.13 on 2019-04-19 22:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(max_length=80, unique=True, verbose_name='Voting category URL slug')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=160, verbose_name='Voting title')),
                ('slug', models.SlugField(max_length=80, unique=True, verbose_name='Voting URL slug')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('published', models.BooleanField(default=True, verbose_name='Voting published')),
                ...
                ('featured', models.BooleanField(default=False, verbose_name='Show on home')),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='votes.Author')),
